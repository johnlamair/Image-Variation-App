...
class ImageVariationApp:
    def __init__(self, root):
        ...
        self.root.geometry("250x250")  # Set the window size (width x height)
    ...
    def setup_ui(self):
        ...
        # Start button
        self.start_button = tk.Button(self.root, text="Generate Variations", command=self.generate_variations)
    ...
    def select_file(self):
        ...
        if self.file_path:
            ...
            self.select_file_button.config(bg="green", fg="green")  # Turn button green
        else:
            print("No file selected.")
            self.select_file_button.config(bg="SystemButtonFace", fg="black")  # Reset button color
    ...
    def select_directory(self):
        ...
        if self.output_directory:
            ...
            self.select_dir_button.config(bg="green", fg="green")  # Turn button green
        else:
            print("No directory selected.")
            self.select_dir_button.config(bg="SystemButtonFace", fg="black")  # Reset button color
